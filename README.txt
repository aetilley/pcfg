...
The author would humbly suggest that anyone interested in using PCFGs in Python in any sort of important project consult these (more robust) libraries first.  (See https://github.com/nltk/nltk)]
